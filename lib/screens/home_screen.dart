...
import 'package:your_guide/repository/repository.dart';
import 'package:your_guide/screens/pages/my_trip_page.dart';
    ...
    return Column(
      ...
      children: <Widget>[
        Row(
          ...
          children: <Widget>[
            Text(
              "Trending Places (Places you should visit )",
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),
            ),
            Text("View All",
                style: TextStyle(
